import { d as aFunction, S as isObject$1, _ as _export, f as arrayMethodIsStrict, b as arrayMethodUsesToLength, c as arrayIteration, r as requireObjectCoercible, p as addToUnscopables, T as arrayIncludes, G as toIndexedObject, e as toLength, U as toInteger, k as global_1, V as classofRaw, v as objectCreate, W as isForced_1, x as descriptors, X as has, Y as redefine, Z as objectGetOwnPropertyNames, o as objectGetOwnPropertyDescriptor, D as objectDefineProperty, J as fails, $ as inheritIfRequired, a0 as toPrimitive, a1 as stringTrim, a2 as objectKeys, a3 as objectPropertyIsEnumerable, q as internalMetadata, a4 as freezing, a5 as _createForOfIteratorHelper, m as _typeof, a6 as _defineProperty, a7 as stringRepeat, M as _createClass, a8 as _asyncToGenerator, N as _classCallCheck, R as _slicedToArray, K as _inherits, L as _createSuper, a9 as _assertThisInitialized, Q as _toConsumableArray, aa as whitespaces, l as createCommonjsModule, ab as commonjsGlobal, A as functionBindContext, j as isArray, t as toObject, ac as arraySpeciesCreate } from './web.url.a4d8e4d4.js';
import { B as notARegexp, C as correctIsRegexpLogic, D as createHtml, E as stringHtmlForced, S as SvelteComponentDev, i as init$1, s as safe_not_equal, d as dispatch_dev, F as globals, v as validate_slots, o as onMount, G as onDestroy, H as svg_element, j as claim_element, k as children$1, g as detach_dev, p as attr_dev, n as add_location, r as insert_dev, I as noop$2, b as binding_callbacks } from './client.93e0d17f.js';
...
var browser = createCommonjsModule(function (module, exports) {
  ...
  (function (global, factory) {
    ...
    var baseJs = ["https://cdn.jsdelivr.net/npm/d3@".concat("6.3.0"), "https://cdn.jsdelivr.net/npm/markmap-view@".concat("0.2.0")].map(function (src) {
      return {
        type: 'script',
        data: {
          src: src
    ...
    var autoload$1 = function autoload$1() {
      loading$1 = loading$1 || loadJS([{
        type: 'script',
        data: {
          src: "https://cdn.jsdelivr.net/npm/prismjs@".concat("1.22.0", "/components/prism-core.min.js")
        }
      }, {
        type: 'script',
        data: {
          src: "https://cdn.jsdelivr.net/npm/prismjs@".concat("1.22.0", "/plugins/autoloader/prism-autoloader.min.js")
        }
      }]);
      return loading$1;
    };
    ...
    function transform$1(transformHooks) {
      ...
      return {
        styles: [{
          type: 'stylesheet',
          data: {
            href: "https://cdn.jsdelivr.net/npm/prismjs@".concat("1.22.0", "/themes/prism.css")
          }
        }]
      };
    }
...
var uniqId$1 = Math.random().toString(36).slice(2, 8);
...
var memoizedPreloadJS$1 = memoize$1(function (url) {
  document.head.append(createElement$1('link', {
    rel: 'preload',
    as: 'script',
    href: url
  }));
...
function loadJSItem$1(item, context) {
  if (item.type === 'script') {
    return new Promise(function (resolve, reject) {
      document.head.append(createElement$1('script', _extends$1({}, item.data, {
        onload: resolve,
        onerror: reject
      })));
    });
...
function loadCSSItem$1(item) {
  if (item.type === 'style') {
    document.head.append(createElement$1('style', {
      textContent: item.data
    }));
  } else if (item.type === 'stylesheet') {
    document.head.append(createElement$1('link', _extends$1({
      rel: 'stylesheet'
    }, item.data)));
  }
}

function loadJS$1(_x, _x2) {
  return _loadJS$1.apply(this, arguments);
}

function _loadJS$1() {
  _loadJS$1 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(items, context) {
    var needPreload, _iterator3, _step3, item;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (needPreload.length > 1) needPreload.forEach(function (item) {
              return memoizedPreloadJS$1(item.data.src);
            });
            context = _extends$1({
              getMarkmap: function getMarkmap() {
                return window.markmap;
          ...
          case 6:
            ...
            item = _step3.value;
            _context.next = 10;
            return loadJSItem$1(item, context);
...
/* src/components/markmap.svelte generated by Svelte v3.29.4 */
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			children$1(svg).forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			...
			add_location(svg, file, 83, 0, 1773);
		},
...
export { Markmap_1 as M, lodash_debounce as a, browser as b, loadJS as l };

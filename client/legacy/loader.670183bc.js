import { m as _typeof, M as _createClass, N as _classCallCheck, Q as _toConsumableArray, a8 as _asyncToGenerator, a5 as _createForOfIteratorHelper, R as _slicedToArray } from './web.url.a4d8e4d4.js';
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, U as createEventDispatcher, V as create_slot, e as element, c as space, j as claim_element, k as children, g as detach_dev, h as claim_space, p as attr_dev, n as add_location, r as insert_dev, u as append_dev, T as listen_dev, W as update_slot, y as transition_in, z as transition_out, t as text, l as claim_text, Q as set_data_dev, X as empty, Y as group_outros, Z as check_outros, o as onMount, _ as _goto, $ as assign, a0 as exclude_internal_props, f as create_component, m as claim_component, w as mount_component, A as destroy_component, b as binding_callbacks, a1 as prevent_default, I as noop, a2 as run_all, a3 as showToast } from './client.93e0d17f.js';
import './markmap.5c58ae49.js';
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 15, 2, 237);
			attr_dev(div1, "class", "text-sm");
			add_location(div1, file, 20, 4, 427);
			attr_dev(div2, "class", "modal-content");
			add_location(div2, file, 16, 2, 297);
			attr_dev(div3, "class", "modal");
			add_location(div3, file, 14, 0, 215);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(div0, "click", /*handleClose*/ ctx[2], false, false, false);
				mounted = true;
			}
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "text-center text-lg font-semibold mb-2");
			add_location(div, file, 18, 6, 347);
		},
		m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const writable_props = ["show", "title"];
...
// (58:0) <Modal show={showConfirm} on:close={handleCancel} title="Your changes will be lost!">
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p, file$1, 58, 2, 1311);
			add_location(a0, file$1, 60, 4, 1435);
			attr_dev(a1, "class", "text-gray-500");
			add_location(a1, file$1, 61, 4, 1492);
			attr_dev(div, "class", "modal-footer");
			add_location(div, file$1, 59, 2, 1404);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen_dev(a0, "click", prevent_default(/*handleCancel*/ ctx[2]), false, true, false),
					listen_dev(a1, "click", prevent_default(/*handleGoToFullView*/ ctx[3]), false, true, false)
				];
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(58:0) <Modal show={showConfirm} on:close={handleCancel} title=\\\"Your changes will be lost!\\\">",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", div_class_value = /*$$props*/ ctx[4].class);
			add_location(div, file$1, 55, 0, 1171);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$new_props => {
		...
		if ("mm" in $$props) $$invalidate(5, mm = $$new_props.mm);
		if ("dirty" in $$props) $$invalidate(6, dirty = $$new_props.dirty);
		if ("showBrand" in $$props) $$invalidate(7, showBrand = $$new_props.showBrand);
		if ("isFull" in $$props) $$invalidate(8, isFull = $$new_props.isFull);
		if ("showConfirm" in $$props) $$invalidate(1, showConfirm = $$new_props.showConfirm);
	};
...
class Toolbar_1 extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*mm*/ ctx[5] === undefined && !("mm" in props)) {
			console.warn("<Toolbar> was created without expected prop 'mm'");
		}

		if (/*dirty*/ ctx[6] === undefined && !("dirty" in props)) {
